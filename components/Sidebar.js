function Sidebar({ isOpen, toggleSidebar }) {
  try {
    ...
    return (
      <div 
        className={`fixed top-0 left-0 h-full bg-black text-white transition-all duration-300 z-50 ${isOpen ? 'w-64' : 'w-0'} overflow-hidden`}
        data-name="sidebar"
      ...
      >
        ...
        {!isOpen && (
          <button
            ...
            className="fixed top-4 left-4 bg-black text-white p-2 rounded z-40"
          >
